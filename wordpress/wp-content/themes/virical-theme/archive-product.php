 ...
 * This file provides a consistent layout with category.php.
 *
 * @package Virical
 */
...
<style>
    ...
    .product-categories-list a:hover, .product-categories-list a.active {
        border-color: #3B82F6;
...
<main id="primary" class="site-main container mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-24">
    ...
    <header class="page-header mb-8">
        <h1 class="page-title text-3xl font-bold text-black">Sản phẩm</h1>
    </header>
